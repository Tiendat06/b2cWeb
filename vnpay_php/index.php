<?php
    ...
    $username = $_SESSION['login_user'];
    $Order_List_ID = $_SESSION['OrderList_ID'];
    ...
    $dataAcc = getCustomerByUsername($username);

    $cus_Name = $dataAcc['Customer_Name'];
    $cus_Email = $dataAcc['Customer_Email'];
    $cus_Address = $dataAcc['Customer_Address'];
...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="/CNPMB2C/vnpay_php/assets/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="/CNPMB2C/vnpay_php/assets/jumbotron-narrow.css" rel="stylesheet">  
        <script src="/CNPMB2C/vnpay_php/assets/jquery-1.11.3.min.js"></script>
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="/CNPMB2C/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?= (intval(array_sum($total_money))) ?>"/>
                    </div>
                    <div class="form-group">
